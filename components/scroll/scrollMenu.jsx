...
export default function menuScroll(props) {
    ...
    return (
        <>
            <div
                id='navScroll'
                className='bg-main-color-2 -top-28 fixed z-30 block w-full'
            >
                    ...
                    <div className='flex'>
                        ...
                        <div className='hidden lg:flex pt-4 uppercase text-sm'>
                            ...
                            <Link
                                ...
                                smooth={true}
                                spy={true}
                                className='cursor-pointer px-8 text-gray-300 hover:text-uriel-blue-light'
                            >
                                Habilidades
                            </Link>
                            <Link
