...
export default function Header() {
  return (
    <section id="header">
        <div className="md:bg-header min-h-screen bg-no-repeat bg-header-size animate-zoomBgAnimation">
        <div className="mainContainer">
          <Menu />
          <TextBox />
        </div>
          <Link to="sobre">
            <div className="flex flex-col items-end sm:items-center xl:pt-24 pb-8 m-auto">
