...
export default function Apresentação() {
    return (
        <div className="md:w-3/5 md:mt-20 mt-3 h-72">
            ...
            <div className="sm:mt-8 text-justify sobre-texto sm:text-base md:text-lg 2xl:text-3xl lg:pr-0 pr-10">
            ...
            <div className="mt-4 sm:mt-8 text-justify sobre-texto sm:text-xl md:text-lg 2xl:text-3xl lg:pr-0 pr-10">
