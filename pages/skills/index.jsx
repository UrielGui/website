            ...
            <div className="bg-skills bg-no-repeat bg-cover bg-center bg-fixed">
                <div className="mainContainer pt-4 pb-10">
                    ...
                    <div className="flex justify-center sm:mt-20 mt-10">
                        <h1 className="text-white sm:text-3xl text-xl 2xl:text-4xl">Conhecimento Profissional</h1>
                    </div>
                    <div className="flex justify-center">
                        <div className="border-bottom-white"></div>
                    </div>
                    <div className="flex justify-center">
                        <div className="text-gray-200 text-opacity-60 sm:text-lg text-xs pt-5 tracking-subtitle 2xl:text-2xl">HABILIDADES</div>
                    </div>
                    <SkillsProgress />
                </div>
            </div>
