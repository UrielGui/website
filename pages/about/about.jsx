        ...
        <div className='md:w-4/5 md:mt-20 mt-3'>
            ...
            <div className='sm:mt-8 text-justify sm:text-base md:text-lg lg:pr-0 '>
                <span className='text-white'>
                    ...
                    e atualmente eu tenho 21 anos. Sou desenvolvedor full stack
                    autodidata e UI Designer. Sou natural do Rio de Janeiro.
                    Meus passatempos incluem desde o aprofundamento em
                    tecnologias, até músicas, livros e filmes.
                </span>
            </div>
